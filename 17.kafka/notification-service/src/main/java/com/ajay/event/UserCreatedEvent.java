...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6153525013863985679L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.ajay.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"default\":0},{\"name\":\"fullName\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"email\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static com.ajay.event.UserCreatedEvent.Builder newBuilder() {
    return new com.ajay.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.ajay.event.UserCreatedEvent.Builder newBuilder(com.ajay.event.UserCreatedEvent.Builder other) {
    return new com.ajay.event.UserCreatedEvent.Builder(other);
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.ajay.event.UserCreatedEvent.Builder newBuilder(com.ajay.event.UserCreatedEvent other) {
    return new com.ajay.event.UserCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ajay.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ajay.event.UserCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder setFullName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder clearFullName() {
      fullName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ajay.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
